...
# BUTTONS
hit_btn = Button(150, 500, 120, 50, "HIT")
stand_btn = Button(290, 500, 120, 50, "STAND")
new_btn = Button(430, 500, 160, 50, "NEW ROUND")

bet5_btn = Button(620, 350, 80, 40, "$5")
bet10_btn = Button(620, 400, 80, 40, "$10")
bet20_btn = Button(620, 450, 80, 40, "$20")
bet50_btn = Button(620, 500, 80, 40, "$50")

restart_btn = Button(320, 400, 160, 60, "RESTART")
...
def draw_game():
    ...
    draw_centered(message, 430, FONT)
